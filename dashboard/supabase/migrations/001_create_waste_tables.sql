-- Create stations table to track connected devices
...
-- Create groups table for organizing stations
...
-- Create waste_items table to track individual detections
...
-- Create user_profiles table to link auth users with roles and groups
