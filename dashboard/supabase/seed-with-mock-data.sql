...
BEGIN
  ...
  FOR i IN 1..500 LOOP
    ...
    IF RANDOM() < 0.3 THEN -- 30% of items
      INSERT INTO public.waste_items (station_id, category, item_type, weight_grams, confidence, detected_at)
